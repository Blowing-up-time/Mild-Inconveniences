...
public class ExportGradleProject {
	...
	private void saveProjectBuildGradle() throws IOException {
		TemplateFile tmpl = TemplateFile.fromResources(R.raw.export_build_gradle,"/export/build.gradle.tmpl");
		tmpl.save(new File(projectDir, "build.gradle"));
	}

	private void saveSettingsGradle() throws IOException {
		TemplateFile tmpl = TemplateFile.fromResources(R.raw.export_settings_gradle,"/export/settings.gradle.tmpl");
	...
	private void saveApplicationBuildGradle() throws IOException {
		TemplateFile tmpl = TemplateFile.fromResources(R.raw.export_app_build_gradle,"/export/app.build.gradle.tmpl");
